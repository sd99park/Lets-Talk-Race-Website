...
export const DP_bio1 =
  "In 2021, David left his 27 year career with Atmos Energy to join Shelley and pursue a calling to racial reconciliation and justice. His previous career started as a Mechanical Engineer and grew into a variety of roles including the his last role as Senior Vice President, Utility Operations.  Now David is working on a Master's in Christian Ministry from Abilene Christian University's Graduate School of Theology.";
...
export const JH_bio1 =
  "JoAnn Hummel graduated from Dallas Theological Seminary with a Master of Arts degree in Theology and Christian Education. She will graduate in December 2022 with a Doctor of Transformational Leadership degree from Bakke Graduate University.";

export const JH_bio2 =
  "In June 2023, JoAnn will celebrate 30 years on the pastoral team at Bent Tree Bible Fellowship in Carrollton, Texas. A gifted communicator, JoAnn speaks with humor, sensitivity, and insight into the Scriptures and is passionate about helping people experience the abundant life found only in Jesus Christ. In addition to local church leadership and preaching, JoAnn has traveled widely to train existing and emerging church leaders around the world.";

export const JH_bio3 =
  "JoAnn envisions people coming into a deep knowing of Jesus’ love for them and through them as the Holy Spirit empowers her to teach, write, mentor and pray.";

export const JH_bio4 =
  "JoAnn is single and shares her home in Lewisville with her canine sidekick, Fergus, the Sheepadoodle.";
...
export const PA_bio4 =
  "Pamela’s overarching passion is connecting with people and promoting unity in community.  She currently lives in Dallas, TX and has two adult children she admires, loves and adores as two of her closest friends.";
...
export const OW_bio2 =
  "During his tenure as Vice President of Marketing in the Mid-Tex division his team developed an innovative Growth Database to track information related to builders, developers, potential and new customers. In his role as Vice President of Public Affairs, Oric was responsible for enhancing the image and reputation of the company. He supported the community engagement and philanthropic efforts with a team of public affairs managers. Oric assumed the role as President for the Louisiana division on January 1, 2022. Atmos Energy serves over 373,000 distribution customers across the state of Louisiana. ";

export const OW_bio3 =
