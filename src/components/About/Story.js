        ...
        <div className="story-one">
          <div className="story-one-txt">
            <p className="story-p">
              ...
              Conversations About Race was a 4 week class created by Ron Holland
              at The Hills church in Ft. Worth, Texas in the summer of 2018.
              “Let's Get Ready to Talk About Race” was later promoted by the
              church following their pastor's six week sermon called “Why Talk
              About Race?” in January of 2019. It was intended to prepare White
              people to be able to have meaningful conversations about race in a
              multiracial/multiethnic environment. Ron recognized that there was
              a lot of history and a lot of vocabulary that White people just
              didn't know.
            </p>
            <p className="story-p">
        ...
        <div className="story-two">
          ...
          <div className="story-two-txt">
            <p className="story-p">
              ...
              Talk Race.” It was during this class, that George Floyd was
            ...
            <p className="story-p">
              ...
              husband, David, took more than 300 folks through the class over
              the next 18 months. The class was never advertised, only spread
              via word of mouth and participants came from all over the United
              States. Ron Holland continued to host classes at his church and
              also took several church leadership groups through the material.
            </p>
            <p className="story-p">
              In the fall of 2022, Shelley & David formed LTR Ministries, a
              501(c)3 not for profit organization aimed at helping white people
              begin the journey of racial reconciliation.
            </p>
          </div>
        </div>
      </div>
